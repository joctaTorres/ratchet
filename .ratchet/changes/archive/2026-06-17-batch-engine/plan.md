...
- [x] 6.1 Implement gate handling (voluntary, after-propose, every-phase, autonomous) and step parking
- [x] 6.2 Implement resume with recorded answer and reject-with-feedback re-running propose without rollback
...
- [x] 8.1 Implement license authentication and per-run authorization with a signed offline-grace lease
- [x] 8.2 Refuse to spawn any agent without valid authorization; surface licensing errors clearly
- [x] 8.3 Confirm the open CLI status/view/config paths remain fully functional with the engine absent or unlicensed
- [x] 9.1 Tests: step selection, transition order, proof-of-work pass/fail gating, gate parking/resume, journal resume, license-absent refusal
