...
export function getProjectSchemasDir(projectRoot: string): string {
  return path.join(projectRoot, RATCHET_DIR_NAME, 'schemas');
}
 ...
 * 1. Project-local: <projectRoot>/ratchet/schemas/<name>/schema.yaml
 * 2. User override: ${XDG_DATA_HOME}/ratchet/schemas/<name>/schema.yaml
