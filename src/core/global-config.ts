...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'ratchet';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'ratchet';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/ratchet/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/ratchet/
 * - Windows fallback: %APPDATA%/ratchet/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/ratchet/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/ratchet/
 * - Windows fallback: %LOCALAPPDATA%/ratchet/
 */
