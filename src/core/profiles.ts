 ...
 */
export const CORE_WORKFLOWS = ['propose', 'apply', 'verify', 'archive', 'propose-standard', 'apply-batch', 'archive-batch', 'propose-batch', 'decompose-phase', 'brainstorm', 'pr-open'] as const;
 ...
 */
export const ALL_WORKFLOWS = ['propose', 'apply', 'verify', 'archive', 'propose-standard', 'apply-batch', 'archive-batch', 'eval', 'propose-batch', 'decompose-phase', 'brainstorm', 'pr-open'] as const;
