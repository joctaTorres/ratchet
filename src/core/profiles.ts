 ...
 */
export const CORE_WORKFLOWS = ['propose', 'apply', 'verify', 'archive', 'propose-standard', 'apply-batch', 'propose-batch'] as const;
 ...
 */
export const ALL_WORKFLOWS = ['propose', 'apply', 'verify', 'archive', 'propose-standard', 'apply-batch', 'eval', 'propose-batch'] as const;
